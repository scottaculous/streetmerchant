...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      rx5600xt: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX6800),
      rx5700: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX6800XT),
      rx5700xt: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX6900XT),
