...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      intex:  envOrArray(process.env.DISCORD_NOTIFY_GROUP_INTEX),
      rx5700: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX5700),
      rx5700xt: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX5700XT),
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      intex: envOrNumber(process.env.MAX_PRICE_SERIES_INTEX),
      rx5700: envOrNumber(process.env.MAX_PRICE_SERIES_RX5700),
      rx5700xt: envOrNumber(process.env.MAX_PRICE_SERIES_RX5700XT),
